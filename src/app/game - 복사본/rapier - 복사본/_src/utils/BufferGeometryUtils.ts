const getWithKey = <T, K extends keyof T>(obj: T, key: K): T[K] => obj[key]
...
export const mergeBufferGeometries = (geometries: BufferGeometry[], useGroups?: boolean): BufferGeometry | null => {
  ...
  geometries.forEach((geom: any, i: number): any => {
 ...
 */
export const mergeBufferAttributes = (attributes: BufferAttribute[]):any=> { // : BufferAttribute | null | undefined 
