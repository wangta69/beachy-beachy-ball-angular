...
export interface ColliderOptions<ColliderArgs extends Array<unknown>> {
   ...
   */
  // position?: any[][]; // ThreeElements["object3D"]["position"];
  position?: Vector3;
  /**
   * The rotation of this collider relative to the rigid body
   */
  // rotation?: any[][]; // ThreeElements["object3D"]["rotation"];
  rotation?: Quaternion;
  /**
   * The rotation, as a Quaternion, of this collider relative to the rigid body
   */
  quaternion?: any[][]; // ThreeElements["object3D"]["quaternion"];
...
export interface RigidBodyOptions extends Omit<ColliderProps, "ref"> {
   ...
   */
  // rotation?: any[][]; // ThreeElements["object3D"]["rotation"];
  rotation?: Quaternion; // ThreeElements["object3D"]["rotation"];
  /**
   ...
   */
  userData?: any; // ThreeElements["object3D"]["userData"];
...
export type FixedJointParams = [
  body1Anchor: any, // Vector3,
  body1LocalFrame: any, // Quaternion,
  body2Anchor: any, // Vector3,
  body2LocalFrame: any, // Quaternion
];
...
export interface UseImpulseJoint<JointParams, JointType extends ImpulseJoint> {
  (
    body1:  any, // RefObject<RapierRigidBody>,
    body2:  any, // RefObject<RapierRigidBody>,
    params: JointParams
  ):  any // RefObject<JointType | undefined>;
}
